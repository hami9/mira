...
> وضعیت فعلی: **فاز ۶ — امکانات اضافه** تکمیل و با سرویس واقعی تست شده — اتوماسیون، یادداشت داخلی، API عمومی و وب‌هوک، احراز هویت دومرحله‌ای، مدیریت اپراتورها و دسترسی‌های دقیق، صفحات بازدیدکنندگان، و تنظیمات کامل هوش مصنوعی از داشبورد. فاز ۷ (سخت‌سازی و استقرار) باقی مانده است.
