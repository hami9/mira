...
> وضعیت فعلی: **همه‌ی فازهای ۰ تا ۷ تکمیل — آماده‌ی انتشار.** چت زنده، داشبورد کامل، افزونه ووکامرس، هوش مصنوعی با RAG، گزارش‌گیری، اتوماسیون و API/وب‌هوک، مدیریت اپراتور با دسترسی نقش‌محور، و سخت‌سازی امنیتی با استقرار خودکار SSL و بک‌آپ دوره‌ای. راهنمای استقرار و چک‌لیست امنیتی پایین‌تر در همین فایل است.
