...
> وضعیت فعلی: **فاز ۴ — هوش مصنوعی** تکمیل و با کلید API واقعی (Gemini) تست شده — پایگاه دانش، ربات پاسخ‌گوی RAG، Copilot، escalation و خلاصه‌سازی. فازهای بعدی طبق نقشه راه پروژه پیاده‌سازی می‌شوند.
